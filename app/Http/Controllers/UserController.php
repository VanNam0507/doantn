...
class UserController extends Controller
{
    public function index(){
        ...
        $totalTransactionCancel=Transaction::where([
            ...
            'tr_status'=>Transaction::STATUS_CANCEL
        ])->count();
        $transactions=Transaction::where('user_id',get_data_user('web'))->orderByDesc('id')->paginate(5);
        return view('user.index',compact('totalTransaction','totalTransactionDone','transactions','totalTransactionCancel'));
    }
    ...
    public function orderCancel($id){
        ...
        $transaction->tr_status=Transaction::STATUS_CANCEL;
        $transaction->save();
