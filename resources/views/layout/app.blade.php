...
<head>
    ...
    <!-- font-icon CSS
    ============================================ -->
    <link rel="stylesheet" href="{{asset('home/fonts/font-icon.css')}}">
    ...
    <!-- nivo slider CSS
    ============================================ -->
    <link rel="stylesheet" href="{{asset('home/custom-slider/css/nivo-slider.css')}}" type="text/css" />
    <link rel="stylesheet" href="{{asset('home/custom-slider/css/preview.css')}}" type="text/css" media="screen" />
...
============================================ -->
<script src="{{asset('home/js/vendor/jquery-1.11.3.min.js')}}"></script>
...
<!-- Nivo slider js
============================================ -->
<script src="{{asset('home/custom-slider/js/jquery.nivo.slider.js')}}" type="text/javascript"></script>
<script src="{{asset('home/custom-slider/home.js')}}" type="text/javascript"></script>
...
<!-- elevateZoom js
============================================ -->
<script src="{{asset('home/js/jquery.elevateZoom-3.0.8.min.js')}}"></script>
