                                ...
                                <div class="row">
                                    <div class="features-curosel">
                                        @if(isset($productsHot))
                                            <?php $count = count($productsHot); ?>
                                            @foreach($productsHot as $key=> $productHot)
                                                @if($productHot->category->c_active!=0)
                                                    @if($key%2==0)
                                                        <div class="col-lg-12 col-md-12">
                                                        @endif
                                                            <div class="single-product @if($key%2==0)first-sale @endif">
                                                                <div class="product-img">
                                                                    ...
                                                                    <a href="{{route('product.detail',[$productHot->pro_slug,$productHot->id])}}">
                                                                        <img class="primary-image"
                                                                             src="{{asset(pare_url_file($productHot->pro_image,'product'))}}"
                                                                             alt=""/>
                                                                        ...
                                                                        <div class="action-buttons">
                                                                            <div class="add-to-links">
                                                                                ...
                                                                                <div class="compare-button">
                                                                                    <a href="{{route('cart.addProduct',$productHot->id)}}"
                                                                                       title="Add to Cart"><i
                                                                                            class="icon-bag"></i></a>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="product-content">
                                                                    <h2 class="product-name"><a
                                                                            href="{{route('product.detail',[$productHot->pro_slug,$productHot->id])}}">{{$productHot->pro_name}}</a></h2>
                                                                    <p>{{$productHot->pro_desc}}</p>
                                                                </div>
                                                            </div>
                                                            @if($key%2!=0||++$key==$count)
                                                        </div>
                                                        @endif
                                                @endif
                                                    @endforeach
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="profile">
                                <div class="row">
                                    <div class="features-curosel">
                                        @if(isset($productsHot))
                                            @foreach($productsHot  as  $key=>$productHot )
                                                @if($productHot->category->c_active)
                                                    @if($key%2==0)
                                                        <div class="col-lg-12 col-md-12">
                                                            @endif
                                                            <div class="single-product @if($key%2==0)first-sale @endif">
                                                                ...
                                                                <div class="product-img">
                                                                    ...
                                                                    <a href="{{route('product.detail',[$productHot->pro_slug,$productHot->id])}}">
                                                                        <img class="primary-image"
                                                                             src="{{pare_url_file($productHot->pro_image,'product')}}"
                                                                             alt="{{$productHot->pro_name}}"/>
                                                                        <img class="secondary-image"
                                                                             src="{{pare_url_file($productHot->pro_image,'product')}}"
                                                                             alt="{{$productHot->pro_name}}"/>
                                                                    </a>
                                                                    ...
                                                                    <div class="actions">
                                                                        <div class="action-buttons">
                                                                            <div class="add-to-links">
                                                                                ...
                                                                                <div class="compare-button">
                                                                                    <a href="{{route('cart.addProduct',$productHot->id)}}" title="Add to Cart"><i
                                                                                            class="icon-bag"></i></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="product-content">
                                                                    <h2 class="product-name"><a
                                                                            href="{{route('product.detail',[$productHot->pro_slug,$productHot->id])}}">{{$productHot->pro_name}}</a>
                                                                    </h2>
                                                                    <p>{{$productHot->pro_desc}}</p>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="single-product first-sale">
                                            <div class="product-img" style="width: 270px;height: 270px">
                                                ...
                                                @if ($productNew->pro_sale)
                                                    <span
                                                        style="position: absolute;font-size:10px;background-image: linear-gradient(-90deg,#ec1f1f 0%,#ff9c00 100%);border-radius: 10px;padding: 3px 7px;color: white;right: 0">{{ $productNew->pro_sale }}%</span>
                                                @endif
                                                <a href="{{route('product.detail',[$productNew->pro_slug,$productNew->id])}}">
                                                    <img class="primary-image"
                                                         src="{{asset(pare_url_file($productNew->pro_image,'product'))}}"
                                                         alt=""/>
                                                    <img class="secondary-image"
                                                         src="{{asset(pare_url_file($productNew->pro_image,'product'))}}"
                                                         alt=""/>
                                                ...
                                                <div class="actions">
                                                    <div class="action-buttons">
                                                        <div class="add-to-links">
                                                            ...
                                                            <div class="compare-button">
                                                                <a href="{{route('cart.addProduct',$productNew->id)}}"
                                            ...
                                            <div class="product-content">
                                                <h2 class="product-name"><a
                                                        href="{{route('product.detail',[$productNew->pro_slug,$productNew->id])}}">{{$productNew->pro_name}}</a>
                                                </h2>
                                ...
                                <div class="single-post" style="margin-bottom: 40px">
                                    <div class="post-thumb">
                                        <a href="{{route('article.detail',[$article->a_slug,$article->id])}}">
                                            <img src="{{asset(pare_url_file($article->a_avatar,'article'))}}" alt=""
                        ...
                        <div class="col-md-4">
                            ...
                            @if(isset($categoryHome->product))
                                <div class="block-carousel">
                                    <?php $count=count($categoryHome->product); ?>
                                    @foreach($categoryHome->product as $key=> $productHome)
                                        @if($key%2==0)
                                        ...
                                        @endif
                                            ...
                                            <div class="single-block">
                                                <div class="block-image pull-left">
                                                    <a href="{{route('product.detail',[$productHome->pro_slug,$productHome->id])}}"><img
                                                            style="width: 170px;height: 208px"
                                                            src="{{asset(pare_url_file($productHome->pro_image,'product'))}}"
                                                            alt=""/></a>
                                                </div>
                                                <div class="category-info">
                                                    <h3>
                                                        <a href="{{route('product.detail',[$productHome->pro_slug,$productHome->id])}}">{{$productHome->pro_name}}</a>
                                                    </h3>
                                                    <p>{{$productHome->pro_desc}}</p>
                                                    <div
                                                        class="cat-price">{{ number_format(round((100 - $productHome->pro_sale) * $productHome->pro_price / 100,0),0,',','.') }}
                                                        đ<span class="old-price">{{number_format($productHome->pro_price,0,',','.')}}đ</span>
                                                    </div>
                                                    <?php
                                                    $rateDetail = 0;
                                                    ...
                                                    <div class="cat-rating">
                                                        @for($i=1;$i<=5;$i++)
                                                            <a href="#"><i
                                                                    class="fa fa-star {{$i<=$rateDetail?'active':''}}"></i></a>
                                                        @endfor
                                                        <p>({{$productHome->pro_total_rating}} đánh giá)</p>
                                                    </div>
                                                </div>
                                            </div>
                                            @if($key%2!=0 || $key==$count-1)
                                        </div>
                                            @endif
                                    @endforeach
                                </div>
