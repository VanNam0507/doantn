...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $contactByDay=Contact::whereDay('created_at',date('d'))->count();
        $ratingByDay=Rating::whereDay('created_at',date('d'))->count();
        ...
        return view('admin::index',compact('contacts','ratings','contactByDay','ratingByDay','moneyByDay','moneyByMonth','transactionByDay','userByMonth','transactionNews'));
    }
    ...
    public function postInfo(Request $request){
        $admin= Admin::find(get_data_user('admins','id'));
