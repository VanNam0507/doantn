...
use Modules\Admin\Http\Controllers\PageStaticController;
...
Route::prefix('admin')->middleware('CheckLoginAdmin')->group(function() {
    ...
    Route::post('/info',[AdminController::class,'postInfo']);
    ...
    Route::group(['prefix'=>'page_static'],function (){
        Route::get('/',[PageStaticController::class,'index'])->name('admin.page_static.index');
        Route::get('/create', [PageStaticController::class, 'create'])->name('admin.page_static.create');
        Route::post('/create', [PageStaticController::class, 'store']);
        Route::get('/edit/{id}',[PageStaticController::class,'edit'])->name('admin.page_static.edit');
        Route::post('/edit/{id}',[PageStaticController::class,'update']);
        Route::get('/delete/{id}',[PageStaticController::class,'delete'])->name('admin.page_static.delete');
    });
});
